...
#define		ISI_CFG2_YCC_SWAP_MASK	(3 << 28)
#define ISI_CFG2_IM_VSIZE_OFFSET		0
#define ISI_CFG2_IM_HSIZE_OFFSET		16
#define ISI_CFG2_IM_VSIZE_MASK		(0x7FF << ISI_CFG2_IM_VSIZE_OFFSET)
#define ISI_CFG2_IM_HSIZE_MASK		(0x7FF << ISI_CFG2_IM_HSIZE_OFFSET)
#define ISI_CFG2_COL_SPACE			(1 << 15)
#define ISI_CFG2_RGB_MODE			(1 << 12)

/* Bitfields in PSIZE */
#define ISI_PSIZE_IM_VSIZE_OFFSET		0
#define ISI_PSIZE_IM_HSIZE_OFFSET		16
#define ISI_PSIZE_IM_VSIZE_MASK		(0x3FF << ISI_PSIZE_IM_VSIZE_OFFSET)
#define ISI_PSIZE_IM_HSIZE_MASK		(0x3FF << ISI_PSIZE_IM_HSIZE_OFFSET)
