...
static void sam9x5ek_can1_transceiver_switch(int on)
{
	pr_info("%s: XXX: please implement me\n", __func__);
}

static struct at91_can_data sam9x5ek_can1_data = {
	.transceiver_switch = sam9x5ek_can1_transceiver_switch,
};
...
static void __init ek_board_init(void)
{
	...
	if (cpu_is_at91sam9x25() || cpu_is_at91sam9x35())
		...
		at91_add_device_can(1, &sam9x5ek_can1_data);
