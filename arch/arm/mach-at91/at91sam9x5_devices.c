...
static struct resource lcdc_resources[] = {
	[0] = {
		.start	= AT91SAM9X5_LCDC_BASE,
		.end	= AT91SAM9X5_LCDC_BASE + SZ_4K - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
...
static struct resource tsadcc_resources[] = {
	[0] = {
		.start	= AT91SAM9X5_BASE_TSC,
		.end	= AT91SAM9X5_BASE_TSC + SZ_16K - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
		.start	= AT91SAM9X5_ID_TSC,
		.end	= AT91SAM9X5_ID_TSC,
		.flags	= IORESOURCE_IRQ,
	}
};
